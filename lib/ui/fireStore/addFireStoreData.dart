...
import 'package:college_app/ui/fireStore/getFireStoreData.dart';
        ...
        child: Column(
          children: [
            ...
            ButtonOne(
                ...
                h: 50,
                onTap: (){
                  Navigator.push(context, PageTransition(child: GetFireStoreDataScreen(), type: PageTransitionType.fade));
                }),
